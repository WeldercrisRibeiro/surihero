        ...
        <div className="flex w-full items-center justify-between gap-2 min-w-0">
          ...
          <div className="flex-1 flex items-center justify-end gap-2 min-w-0">
            ...
            <div className="hidden md:flex items-center gap-3 pl-4 border-l border-slate-200 dark:border-slate-800">
               ...
               <div className="flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 px-3 py-1 rounded-full">
                 <div className="h-1.5 w-1.5 rounded-full bg-primary-500 animate-pulse" />
                 <span className="text-[9px] font-bold text-primary-600 dark:text-primary-400 uppercase tracking-widest">Online</span>
               </div>
            </div>
